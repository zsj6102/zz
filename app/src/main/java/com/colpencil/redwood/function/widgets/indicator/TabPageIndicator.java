 ...
 */
package com.colpencil.redwood.function.widgets.indicator;
...
public class TabPageIndicator extends HorizontalScrollView implements
	...
	private Select_ViewPager select_ViewPager;
	...
	private final OnClickListener mTabClickListener = new OnClickListener() {
		public void onClick(View view) {
			...
			if(select_ViewPager!=null){
				
				select_ViewPager.changeView();
			}
	...
	public void setSelect_ViewPager(Select_ViewPager select_ViewPager){//设置监听
		this.select_ViewPager=select_ViewPager;
	}
...
//		tabView.setTextSize(DpAndPx.dip2px(getContext(), 6));//改变字体大小
		if (iconResId != 0) {
	...
	public interface Select_ViewPager{
		void changeView();
	}
