package com.colpencil.redwood.function.widgets.scroll;
...
import com.colpencil.redwood.function.widgets.scroll.utils.ScrollUiUtils;
...
public class DoubleScrollViewWrapper extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        heitht = ScrollUiUtils.getScreenHeight(context) - ScrollUiUtils.getStatusBarHeight(context) - ScrollUiUtils.dp2px(context, padding);
        a.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isSetted) {
            ...
            if (pageTwo instanceof PageTwoWebView) {
                com.tencent.smtt.sdk.WebSettings settings = ((PageTwoWebView) pageTwo).getSettings();
                settings.setJavaScriptEnabled(true);
                ((PageTwoWebView) pageTwo).setWebViewClient(new com.tencent.smtt.sdk.WebViewClient() {
                    @Override
