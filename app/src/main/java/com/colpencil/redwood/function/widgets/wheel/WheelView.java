...
package com.colpencil.redwood.function.widgets.wheel;
...
import com.colpencil.redwood.function.widgets.wheel.Adapters.WheelViewAdapter;
...
//	}
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		// TODO: make it static
		itemsLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
...
//		canvas.drawColor(Color.parseColor("#020031"));
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.line_color_first));
		// 设置线宽
