...
public class ImageSelectAdapter extends RecyclerView.Adapter<ImageSelectAdapter.SelectedPicViewHolder> {
    ...
    public ImageSelectAdapter(Context mContext, List<ImageItem> data, int maxImgCount) {
    ...
    public SelectedPicViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SelectedPicViewHolder(mInflater.inflate(R.layout.activity_albumitem_published_grida, parent, false));
    }
