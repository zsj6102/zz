...
public class ItemSearchCycloAdapter extends CommonAdapter<CyclopediaInfoVo> {

    private Context context;

    public ItemSearchCycloAdapter(Context context, List<CyclopediaInfoVo> mDatas, int itemLayoutId) {
