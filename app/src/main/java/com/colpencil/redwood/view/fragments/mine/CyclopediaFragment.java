...
public class CyclopediaFragment extends ColpencilFragment implements ICyclopediaFragmentView, BGARefreshLayout.BGARefreshLayoutDelegate {
...
//				item1.setIcon(R.drawable.shezhixingchuhuancun);//设置图标
