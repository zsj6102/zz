...
public class GetCouponFragment extends ColpencilFragment implements IMyCouponsFragmentView {
    ...
    private void initData() {
        ...
        mAdapter = new MyCouponsFragmentAdapter(getActivity(), mdata, R.layout.item_voucher, 1, 1);
