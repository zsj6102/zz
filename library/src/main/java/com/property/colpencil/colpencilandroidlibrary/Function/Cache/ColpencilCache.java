package com.property.colpencil.colpencilandroidlibrary.Function.Cache;
...
import com.property.colpencil.colpencilandroidlibrary.Function.Tools.AppUtils;
import com.property.colpencil.colpencilandroidlibrary.Function.Tools.FileUtil;
import com.property.colpencil.colpencilandroidlibrary.Function.Tools.StreamUtil;
...
/**
 * @Description:缓存抽象类，封装了缓存的读写操作
 * @author 汪 亮
 * @Email  DramaScript@outlook.com
 * @date 16/6/23
 */
public abstract class ColpencilCache implements CacheParam {
    private static final String TAG = "ColpencilCache";
    /**
     * 磁盘缓存工具
     */
     ...
     */
    protected ColpencilCache(Context context, boolean useMemory) {
     ...
     */
    protected ColpencilCache(Context context, boolean useMemory, @NonNull String cacheDir) {
        this.mContext = context;
        this.useMemory = useMemory;
    ...
    protected void initDiskCache(String cacheDir, int valueCount, long cacheSize) {
        try {
            ...
            FileLog.e(this, "createCacheFailed\n" + FileLog.getExceptionString(e));
        }
    }
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    FileLog.e(this, "writeDiskFailed[key:" + key + ",hashKey:" + hashKey + "]\n" + FileLog.getExceptionString(e));
                } finally {
                    if (out != null) {
                        try {
                            out.close();
    ...
    protected byte[] readDiskCache(@NonNull String key) {
        ...
        synchronized (mDiskCacheLock) {
            ...
            try {
                ...
                FileLog.e(this, "readDiskCacheFailed[key:" + key + ",hashKey:" + hashKey + "]\n" + FileLog.getExceptionString(e));
            } catch (Exception e) {
                FileLog.e(this, "readDiskCacheFailed[key:" + key + ",hashKey:" + hashKey + "]\n" + FileLog.getExceptionString(e));
            } finally {
                if (inputStream != null) {
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    ...
                    FileLog.e(this, "removeCacheFailed[key:" + key + ",hashKey:" + hashKey + "]\n" + FileLog.getExceptionString(e));
                }
            }
        }
    }
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    ...
                    FileLog.e(this, "clearCacheFailed" + FileLog.getExceptionString(e));
                }
            }
        }
    }
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    ...
                    FileLog.e(this, "closeDiskCacheFailed" + FileLog.getExceptionString(e));
                }
            }
        }
    }
        ...
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    ...
                    FileLog.e(this, "flushDiskCacheFailed" + FileLog.getExceptionString(e));
                }
            }
        }
    }
