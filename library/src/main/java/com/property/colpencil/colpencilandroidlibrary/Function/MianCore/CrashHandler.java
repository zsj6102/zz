...
import com.property.colpencil.colpencilandroidlibrary.Function.Http.HttpUtil;
import com.property.colpencil.colpencilandroidlibrary.Function.Tools.AndroidUtils;
import com.property.colpencil.colpencilandroidlibrary.Function.Tools.CalendarUtils;
...
//            android.os.Process.killProcess(android.os.Process.myPid());
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                ToastTools.showLong(mContext, "很抱歉，程序出现异常，即将退出");
                Looper.loop();
            }
        }.start();
    ...
    private void sendExceptionInfo(final Throwable ex) {
        ...
        info.exceptionMsg = FileLog.getExceptionString(ex);
