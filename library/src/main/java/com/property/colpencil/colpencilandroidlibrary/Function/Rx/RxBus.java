package com.property.colpencil.colpencilandroidlibrary.Function.Rx;
...
public class RxBus {
    ...
    public <T> Observable<T> register(@NonNull Object tag, @NonNull Class<T> clazz) {
        ...
        ColpencilLogger.e("{register}subjectMapper: " + mSubjectMapper);
        return subject;
    }
    ...
    public void unregister(@NonNull Object tag, @NonNull Observable observable) {
        ...
        ColpencilLogger.e("{unregister}subjectMapper: " + mSubjectMapper);
    }
