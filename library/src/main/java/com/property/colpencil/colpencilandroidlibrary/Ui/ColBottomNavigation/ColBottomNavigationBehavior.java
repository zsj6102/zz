 ...
 *
 */
public class ColBottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
	 ...
	 * Constructor
	 */
	public ColBottomNavigationBehavior() {
		super();
	}

	public ColBottomNavigationBehavior(boolean behaviorTranslationEnabled) {
		super();
		this.behaviorTranslationEnabled = behaviorTranslationEnabled;
	}

	public ColBottomNavigationBehavior(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public static <V extends View> ColBottomNavigationBehavior<V> from(V view) {
		...
		CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
				.getBehavior();
		if (!(behavior instanceof ColBottomNavigationBehavior)) {
			throw new IllegalArgumentException(
					"The view is not associated with AHBottomNavigationBehavior");
		}
		return (ColBottomNavigationBehavior<V>) behavior;
	}
