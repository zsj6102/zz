...
package com.property.colpencil.colpencilandroidlibrary.Ui.ColpenciListview;
...
public class BGARefreshLayout extends LinearLayout {
     ...
     * 结束下拉刷新
     */
    public void endRefreshing(int count) {
...
//        ColpenciSnackbarUtil.topShowing(view, count+"",messageColor,backgroundColor);
    }
    ...
    public void setSnackStyle(View view,int messageColor,int backgroundColor) {
        this.view = view;
