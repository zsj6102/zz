...
public class SegmentedGroup extends RadioGroup {
    ...
    private int mCheckedTextColor = R.color.white;//字体颜色
    ...
    public SegmentedGroup(Context context) {
        ...
        mTintColor = resources.getColor(R.color.red);//主题颜色设置
        mMarginDp = (int) getResources().getDimension(R.dimen.radio_button_stroke_border);//内边距设置
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mTintColor = typedArray.getColor(
                    ...
                    getResources().getColor(R.color.white));//字体颜色
    ...
    public SegmentedGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        resources = getResources();
        mTintColor = resources.getColor(R.color.red);//主题颜色
    ...
    private void updateBackground(View view) {
        ...
        ((GradientDrawable) uncheckedDrawable).setStroke(mMarginDp, resources.getColor(R.color.white));//未选中样式
        //Set proper radius
